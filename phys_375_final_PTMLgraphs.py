...
def f(ro_c, T_c, coeff_PP, power_PP, coeff_CNO, power_CNO):
    ...
    P = P_fn(ro, T)
    dL_dr = dL_dr_fn(r, ro, T, coeff_PP, power_PP, coeff_CNO, power_CNO)
    #dT_dr = dT_dr_fn(r, ro, T, M, L)
    epsilon_PP = epsilon_PP_fn(ro, T, coeff_PP, power_PP)
    epsilon_CNO = epsilon_CNO_fn(ro, T, coeff_CNO, power_CNO)
    ...
    return ( eq, R, T_R, L_R, M_tot, r, ro, T, M, dL_dr, tau, kappa, epsilon_PP, epsilon_CNO, kappa_es, kappa_ff, P, ro_c, L, T_c, kappa_H)
...
def bisection(f, ro_min, ro_max, T_c, coeff_PP, power_PP, coeff_CNO, power_CNO) :    
    ...
    low = ro_min
    f_low, R_low, T_low, L_low, M, r_arr, ro_arr, T_arr, M_arr, dL_dr_arr,tau_arr,kappa_arr,epsilon_PP_arr,epsilon_CNO_arr,kappa_es_arr,kappa_ff_arr, P, ro_c,L_arr, T_c_, kappa_H = f(low, T_c, coeff_PP, power_PP, coeff_CNO, power_CNO)
    high = ro_max
    f_high, R_high, T_high, L_high, M, r_arr, ro_arr, T_arr, M_arr, dL_dr_arr,tau_arr,kappa_arr,epsilon_PP_arr,epsilon_CNO_arr,kappa_es_arr,kappa_ff_arr, P, ro_c,L_arr, T_c_, kappa_H = f(high, T_c, coeff_PP, power_PP, coeff_CNO, power_CNO)
    ...
    if f_low*f_high < 0:
        ...
        mid = 0.5*(low+high)
        f_mid, R_mid, T_mid, L_mid, M, r_arr, ro_arr, T_arr, M_arr, dL_dr_arr,tau_arr,kappa_arr,epsilon_PP_arr,epsilon_CNO_arr,kappa_es_arr,kappa_ff_arr, P, ro_c,L_arr, T_c_, kappa_H = f(mid, T_c, coeff_PP, power_PP, coeff_CNO, power_CNO)
        ...
        while (percent_change > change_err):
            ...
            #eq, R, T_R, L_R, M_tot, r, ro, T, M, dL_dr, tau, kappa, epsilon_PP, epsilon_CNO, kappa_es, kappa_ff
            f_mid, R_mid, T_mid, L_mid, M, r_arr, ro_arr, T_arr, M_arr, dL_dr_arr,tau_arr,kappa_arr,epsilon_PP_arr,epsilon_CNO_arr,kappa_es_arr,kappa_ff_arr, P, ro_c, L_arr, T_c_, kappa_H = f(mid, T_c, coeff_PP, power_PP, coeff_CNO, power_CNO)
        #print(count)
    ...
    return (T_mid, L_mid, R_mid, M, r_arr, ro_arr, T_arr, M_arr, dL_dr_arr,tau_arr,kappa_arr,epsilon_PP_arr,epsilon_CNO_arr,kappa_es_arr,kappa_ff_arr, P, ro_c,L_arr, T_c_, kappa_H)
...
star1 = bisection(f, 0.3e3, 500e3, 7.2e6, coeff_PP, power_PP, coeff_CNO, power_CNO)
star2 = bisection(f, 0.3e3, 500e3, 2.2e7, coeff_PP, power_PP, coeff_CNO, power_CNO)
#[T_mid, L_mid, R_mid, M, r_arr, ro_arr, T_arr, M_arr, dL_dr_arr,tau_arr,kappa_arr,epsilon_PP_arr,epsilon_CNO_arr,kappa_es_arr,kappa_ff_arr, P, ro_c,L_arr,T_c_, kappa_H]

plt.title("M/M_solar vs r/R* for star 1")
plt.yticks(fontsize=11, rotation=0) #adjust axis tick numbers font size
plt.xticks(fontsize=11, rotation=0) #adjust axis tick numbers font size
plt.xlabel('Radius, r/R*', fontsize=11)
plt.ylabel('Enclosed Mass, M/M_solar', fontsize=11)
#plt.legend()
#plt.xlim(6e4, 0.9e3)
#plt.ylim(16, -11)
#plt.gca().invert_xaxis()
#plt.gca().invert_yaxis()
plt.grid(True)
plt.plot(star1[4]/star1[2],star1[7]/M_solar)
plt.show()

plt.title("Normalized physical properties vs r/R* for star 1")
plt.yticks(fontsize=11, rotation=0) #adjust axis tick numbers font size
plt.xticks(fontsize=11, rotation=0) #adjust axis tick numbers font size
plt.xlabel('Radius, r/R*', fontsize=11)
plt.ylabel('Rho/Rho_core, T/Tcore, L/L*, M/M*', fontsize=11)
#plt.xlim(6e4, 0.9e3)
#plt.ylim(16, -11)
#plt.gca().invert_xaxis()
#plt.gca().invert_yaxis()
plt.grid(True)
plt.plot(star1[4]/star1[2],star1[5]/star1[16], label="density")
plt.plot(star1[4]/star1[2],star1[6]/star1[18], label="temperature")
plt.plot(star1[4]/star1[2],star1[17]/star1[1], label="luminosity")
plt.plot(star1[4]/star1[2],star1[7]/star1[3], label = "mass")
plt.legend()
plt.show()

plt.title("Pressure vs r/R* for star 1")
plt.yticks(fontsize=11, rotation=0) #adjust axis tick numbers font size
plt.xticks(fontsize=11, rotation=0) #adjust axis tick numbers font size
plt.xlabel('Radius, r/R*', fontsize=11)
...
#plt.gca().invert_yaxis()
plt.grid(True)
plt.plot(star1[4]/star1[2],star1[15])
plt.show()

plt.title("dL/dr vs r/R* for star 1")
plt.yticks(fontsize=11, rotation=0) #adjust axis tick numbers font size
plt.xticks(fontsize=11, rotation=0) #adjust axis tick numbers font size
plt.xlabel('Radius, r/R*', fontsize=11)
plt.ylabel('dL/dr (L*/R*)', fontsize=11)
#plt.legend()
#plt.xlim(6e4, 0.9e3)
#plt.ylim(16, -11)
#plt.gca().invert_xaxis()
#plt.gca().invert_yaxis()
plt.grid(True)
plt.plot(star1[4]/star1[2],star1[8]/(star1[1]/star1[2]))
plt.show()

plt.title("Kappa vs r/R* for star 1")
plt.yticks(fontsize=11, rotation=0) #adjust axis tick numbers font size
plt.xticks(fontsize=11, rotation=0) #adjust axis tick numbers font size
plt.xlabel('Radius, r/R*', fontsize=11)
plt.ylabel('log kappa (m^2/kg)', fontsize=11)
plt.xlim(0, 1)
plt.ylim(10e-3, 10e9)
#plt.gca().invert_xaxis()
#plt.gca().invert_yaxis()
plt.grid(True)
plt.plot(star1[4]/star1[2],star1[19], label="kappa_H")
plt.plot(star1[4]/star1[2],[star1[13] for n in range(len(star1[4]))], label="kappa_es")
plt.plot(star1[4]/star1[2],star1[14], label="kappa_ff")
plt.plot(star1[4]/star1[2],star1[10], label="Kappa")
plt.legend()
plt.yscale('log')
plt.show()
...
plt.title("M/M_solar vs r/R* for star 2")
plt.yticks(fontsize=11, rotation=0) #adjust axis tick numbers font size
plt.xticks(fontsize=11, rotation=0) #adjust axis tick numbers font size
plt.xlabel('Radius, r/R*', fontsize=11)
plt.ylabel('Enclosed Mass, M/M_solar', fontsize=11)
...
#plt.gca().invert_yaxis()
plt.grid(True)
plt.plot(star2[4]/star2[2],star2[7]/M_solar)
plt.show()

plt.title("Normalized physical properties vs r/R* for star 2")
plt.yticks(fontsize=11, rotation=0) #adjust axis tick numbers font size
plt.xticks(fontsize=11, rotation=0) #adjust axis tick numbers font size
plt.xlabel('Radius, r/R*', fontsize=11)
plt.ylabel('Rho/Rho_core, T/Tcore, L/L*, M/M*', fontsize=11)
...
#plt.gca().invert_yaxis()
plt.grid(True)
plt.plot(star2[4]/star2[2],star2[5]/star2[16], label="density")
plt.plot(star2[4]/star2[2],star2[6]/star2[18], label="temperature")
plt.plot(star2[4]/star2[2],star2[17]/star2[1], label="luminosity")
plt.plot(star2[4]/star2[2],star2[7]/star2[3], label = "mass")
plt.legend()
plt.show()

plt.title("Pressure vs r/R* for star 2")
plt.yticks(fontsize=11, rotation=0) #adjust axis tick numbers font size
plt.xticks(fontsize=11, rotation=0) #adjust axis tick numbers font size
plt.xlabel('Radius, r/R*', fontsize=11)
plt.ylabel('Pressure (Pa)', fontsize=11)
...
#plt.gca().invert_yaxis()
plt.grid(True)
plt.plot(star2[4]/star2[2],star2[15])
plt.show()

plt.title("dL/dr vs r/R* for star 2")
plt.yticks(fontsize=11, rotation=0) #adjust axis tick numbers font size
plt.xticks(fontsize=11, rotation=0) #adjust axis tick numbers font size
plt.xlabel('Radius, r/R*', fontsize=11)
plt.ylabel('dL/dr (L*/R*)', fontsize=11)
...
#plt.gca().invert_yaxis()
plt.grid(True)
plt.plot(star2[4]/star2[2],star2[8]/(star2[1]/star2[2]))
plt.show()

plt.title("Kappa vs r/R* for star 2")
plt.yticks(fontsize=11, rotation=0) #adjust axis tick numbers font size
plt.xticks(fontsize=11, rotation=0) #adjust axis tick numbers font size
plt.xlabel('Radius, r/R*', fontsize=11)
plt.ylabel('log kappa (m^2/kg)', fontsize=11)
...
#plt.gca().invert_yaxis()
plt.grid(True)
plt.plot(star2[4]/star2[2],star2[19], label="kappa_H")
plt.plot(star2[4]/star2[2],[star2[13] for n in range(len(star2[4]))], label="kappa_es")
plt.plot(star2[4]/star2[2],star2[14], label="kappa_ff")
plt.plot(star2[4]/star2[2],star2[10], label="Kappa")
plt.legend()
plt.yscale('log')
plt.show()


#print(main_sequence_data[:,5]/M_solar)
